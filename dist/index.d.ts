...
declare class TransactionUtil {
    ...
    static syncBuildCoinInputForAmount(sdk: CetusClmmSDK, tx: Transaction, amount: bigint, coinType: string, buildVector?: boolean): Promise<TransactionObjectArgument | undefined>;
 ...
 * @returns
 */
declare function initMainnetSDK(fullNodeUrl?: string, simulationAccount?: string): CetusClmmSDK;
 ...
 * @returns
 */
declare function initTestnetSDK(fullNodeUrl?: string, simulationAccount?: string): CetusClmmSDK;
