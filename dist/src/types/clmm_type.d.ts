 ...
 */
export declare enum ClmmPositionStatus {
    /**
 ...
 */
export type RemoveLiquidityParams = CoinPairType & CommonParams & {
    /**
 ...
 */
export type ClosePositionParams = CoinPairType & CommonParams & {
    /**
     * Coin types associated with rewarder contracts.
     */
    rewarder_coin_types: SuiAddressType[];
 ...
 */
export declare function getPackagerConfigs<T>(packageObj: Package<T>): T & ({} | null);
export {};
