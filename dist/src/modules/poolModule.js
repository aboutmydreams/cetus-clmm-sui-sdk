...
import { ClmmFetcherModule, ClmmIntegratePoolModule, ClmmPartnerModule, CLOCK_ADDRESS, } from '../types/sui';
import { getObjectPreviousTransactionDigest } from '../utils/objects';
import { ClmmpoolsError, ConfigErrorCode, PartnerErrorCode, PoolErrorCode, PositionErrorCode, RouterErrorCode, UtilsErrorCode, } from '../errors/errors';
/**
